...
const logos = {
  logo_url:props.some.company_logo,
  company_name:props.some.company_name,
  website:props.some.company_website_url
  ...
  return (
    ...
    <div className="largecontain">
      ...
      <div className="topconatiner">
        <div className="companyname">
          <Logos logos = {logos}/>
          <p className="job_name">{props.some.job_title}</p>
    ...
    <div className="basepay">
      ...
      <div className="sal">
        ...
        <p>₹20T/mo Median</p>
        <p>{props.some.city_country_name}</p>
