...
//             <button className='editbtn'><GrEdit /></button>
//           </h3>
...
//             </div>
//             <p className='ques'>Full name*</p>
//             <input type="text" className='inputpro' placeholder={userProfile.username} />
//             <p className='ques'>Location*</p>
//             <input type="text" className='inputpro' placeholder={userProfile.location} />
//             <p className='ques'>Degree type</p>
//             <input type="text" className='inputpro' placeholder={userProfile.degree} />
